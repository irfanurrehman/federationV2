...
import (
	...
	internalclientset "github.com/irfanurrehman/federationV2/pkg/client/clientset_generated/internalclientset"
	internalinterfaces "github.com/irfanurrehman/federationV2/pkg/client/informers_generated/internalversion/internalinterfaces"
	internalversion "github.com/irfanurrehman/federationV2/pkg/client/listers_generated/federation/internalversion"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.Federation().Deployments(namespace).List(options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.Federation().Deployments(namespace).Watch(options)
			},
		},
...
func (f *deploymentInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&federation.Deployment{}, f.defaultInformer)
}
