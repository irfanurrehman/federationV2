...
import (
	...
	"github.com/irfanurrehman/federationV2/pkg/client/informers_generated/externalversions"
...
func (si *SharedInformers) startInformers(shutdown <-chan struct{}) {
	go si.Factory.Federation().V1alpha1().Deployments().Informer().Run(shutdown)
}
