...
import (
	...
	. "github.com/irfanurrehman/federationV2/pkg/client/clientset_generated/clientset/typed/federation/v1alpha1"
...
var _ = Describe("Deployment controller", func() {
	...
	var client DeploymentInterface
	...
	BeforeEach(func() {
		...
		expectedKey = "deployment-controller-test-handler/instance-1"
	})
	...
	Describe("when creating a new object", func() {
		It("invoke the reconcile method", func() {
			client = cs.FederationV1alpha1().Deployments("deployment-controller-test-handler")
